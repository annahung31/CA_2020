module cpu #( // Do not modify interface
        ...
        if (cs == 6) begin
            ...
            if (i_inst_temp[6:0] == 7'b0000011 
             && i_inst_temp[14:12] == 3'b011) begin
                ...
                o_d_r_addr_w = {{52{imm[11]}}, imm[11:0]} + rs1_value;  //addr
            ...
            // SD
                ...
                // $display("%d %x %x %x %x %x", opcode, rs1, rs1_value, {{52{imm[11]}}, imm[11:0]}, o_d_w_addr_w, o_d_data_w);
                

                o_d_w_addr_w = {{52{imm[11]}}, imm[11:0]} + rs1_value;  //addr
    ...
    always @(*) begin
        ...
        // else begin
        //     reg_file[i_inst_temp[11:7]] = reg_file[i_inst_temp[11:7]];
        // end
    end
